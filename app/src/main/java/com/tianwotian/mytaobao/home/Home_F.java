...
public class Home_F extends Fragment {
    ...
    private void initView(View view) {
        ivHomeMine = (ImageView) view.findViewById(R.id.iv_home_mine);
        ivHomeMine.setOnClickListener(new OnClickListener() {
            @Override
        ...
        tvTopSearch = (TextView) view.findViewById(R.id.tv_top_search);
        tvTopSearch.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View arg0) {
                //挑战到宝贝搜索界面
