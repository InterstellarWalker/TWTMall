...
import com.tianwotian.http.CU_VolleyTool;
...
public class Adapter_ListView_ware extends BaseAdapter {
	...
	public View getView(int position, View currentView, ViewGroup arg2) {
		...
		if (arrayList.size() != 0) {
			...
			CU_VolleyTool.getInstance(context).getmImageLoader().get("http://api.tianwotian.com/api/CommListSeach.aspx?Search=\n" +
					arrayList.get(position).get(""), listener);
